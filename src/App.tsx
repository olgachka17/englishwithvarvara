    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-12 md:py-16 relative z-10">
          ...
          >
            ...
            >
              <Badge className="text-sm md:text-base px-5 py-2 bg-soft-pink text-soft-pink-foreground hover:bg-soft-pink/90 shadow-sm font-semibold border-0">
      ...
      <div className="container mx-auto px-4 py-6 max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            >
              <div className="relative group">
                ...
                <motion.div
                  className="absolute -top-6 -right-7 w-16 h-16 rounded-full bg-gradient-to-br from-coral to-[oklch(0.75_0.18_15)] shadow-lg flex items-center justify-center z-10"
                  animate={{ y: [0, -10, 0] }}
                  transition={{ 
                    duration: 4.5, 
                    repeat: Infinity, 
                ...
                <motion.div
                  className="absolute -bottom-5 -left-5 w-14 h-14 rounded-full bg-gradient-to-br from-[oklch(0.88_0.08_15)] to-[oklch(0.75_0.18_15)] shadow-md flex items-center justify-center z-10"
                  animate={{ y: [0, 10, 0] }}
                  transition={{ 
                    duration: 5, 
                    repeat: Infinity, 
                ...
                <motion.div
                  className="absolute top-6 -left-8 w-12 h-12 rounded-full bg-gradient-to-br from-[oklch(0.82_0.16_18)] to-[oklch(0.78_0.18_12)] shadow-md flex items-center justify-center z-10"
                  animate={{ 
                    rotate: [0, 8, -8, 0],
                    scale: [1, 1.05, 1]
                  }}
                ...
                <motion.div
                  className="absolute -top-3 left-10 w-10 h-10 rounded-full bg-gradient-to-br from-[oklch(0.92_0.06_35)] to-[oklch(0.85_0.12_25)] shadow-sm flex items-center justify-center z-10"
                  animate={{ 
                    x: [0, 5, -5, 0],
                    y: [0, -5, 5, 0]
                  }}
                ...
                <motion.div
                  className="absolute bottom-10 -right-8 w-14 h-14 rounded-2xl bg-gradient-to-br from-[oklch(0.83_0.16_20)] to-[oklch(0.80_0.14_15)] shadow-md flex items-center justify-center z-10"
                  animate={{ 
                    rotate: [0, -6, 6, 0]
                  }}
                  transition={{ 
                ...
                <div className="relative p-2 bg-gradient-to-br from-coral via-[oklch(0.82_0.16_18)] to-[oklch(0.88_0.08_15)] rounded-full shadow-2xl">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <motion.div whileHover={{ y: -6, scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
              <Card className="h-full p-5 shadow-lg hover:shadow-2xl transition-all border-0 bg-white/80 backdrop-blur-sm">
                <CardContent className="p-0 space-y-2.5">
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-coral to-[oklch(0.75_0.18_15)] flex items-center justify-center mb-3 shadow-lg">
            ...
            <motion.div whileHover={{ y: -6, scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
              <Card className="h-full p-5 shadow-lg hover:shadow-2xl transition-all border-0 bg-white/80 backdrop-blur-sm">
                <CardContent className="p-0 space-y-2.5">
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[oklch(0.75_0.18_15)] to-[oklch(0.88_0.08_15)] flex items-center justify-center mb-3 shadow-lg">
            ...
            <motion.div whileHover={{ y: -6, scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
              <Card className="h-full p-5 shadow-lg hover:shadow-2xl transition-all border-0 bg-white/80 backdrop-blur-sm">
                <CardContent className="p-0 space-y-2.5">
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[oklch(0.88_0.08_15)] to-[oklch(0.72_0.20_25)] flex items-center justify-center mb-3 shadow-lg">
          ...
          <div className="max-w-5xl mx-auto space-y-6">
            <Card className="p-6 md:p-8 shadow-xl border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-0 space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-3xl bg-gradient-to-br from-coral to-[oklch(0.75_0.18_15)] flex items-center justify-center flex-shrink-0 shadow-lg">
                    <Student size={28} className="text-white" weight="fill" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-2.5 text-coral">Беру любой уровень</h3>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-3xl bg-gradient-to-br from-[oklch(0.75_0.18_15)] to-[oklch(0.88_0.08_15)] flex items-center justify-center flex-shrink-0 shadow-lg">
                    <Chats size={28} className="text-white" weight="fill" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-2.5 text-accent">Живые уроки</h3>
                    <p className="text-base leading-relaxed text-foreground/70">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-3xl bg-gradient-to-br from-[oklch(0.88_0.08_15)] to-[oklch(0.72_0.20_25)] flex items-center justify-center flex-shrink-0 shadow-lg">
                    <Sparkle size={28} className="text-white" weight="fill" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-2.5 text-accent">Современные материалы</h3>
                    <p className="text-base leading-relaxed text-foreground/70">
            ...
            <div className="grid md:grid-cols-3 gap-5">
              <motion.div whileHover={{ y: -6, scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
                <Card className="h-full p-5 shadow-lg hover:shadow-2xl transition-all border-0 bg-white/80 backdrop-blur-sm">
                  <CardContent className="p-0 text-center space-y-2.5">
                    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-coral to-[oklch(0.75_0.18_15)] flex items-center justify-center mx-auto mb-3 shadow-lg">
              ...
              <motion.div whileHover={{ y: -6, scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
                <Card className="h-full p-5 shadow-lg hover:shadow-2xl transition-all border-0 bg-white/80 backdrop-blur-sm">
                  <CardContent className="p-0 text-center space-y-2.5">
                    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[oklch(0.75_0.18_15)] to-[oklch(0.88_0.08_15)] flex items-center justify-center mx-auto mb-3 shadow-lg">
              ...
              <motion.div whileHover={{ y: -6, scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
                <Card className="h-full p-5 shadow-lg hover:shadow-2xl transition-all border-0 bg-white/80 backdrop-blur-sm">
                  <CardContent className="p-0 text-center space-y-2.5">
                    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[oklch(0.88_0.08_15)] to-[oklch(0.72_0.20_25)] flex items-center justify-center mx-auto mb-3 shadow-lg">
            ...
            <Card className="p-6 shadow-xl border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-0">
                <div className="flex items-start gap-4">
                  <CheckCircle size={32} className="flex-shrink-0 mt-1 text-coral" weight="fill" />
                  <div>
          ...
          <div className="grid md:grid-cols-3 gap-5">
              ...
              <Card className="h-full p-5 shadow-lg hover:shadow-2xl transition-all border-0 bg-white/80 backdrop-blur-sm">
                <CardContent className="p-0">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-coral to-[oklch(0.75_0.18_15)] flex items-center justify-center text-white font-bold text-lg shadow-lg">
                      А
                    </div>
                    <div>
            ...
            >
              <Card className="h-full p-5 shadow-lg hover:shadow-2xl transition-all border-0 bg-white/80 backdrop-blur-sm">
                <CardContent className="p-0">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[oklch(0.75_0.18_15)] to-[oklch(0.88_0.08_15)] flex items-center justify-center text-white font-bold text-lg shadow-lg">
                      Д
                    </div>
                    <div>
            ...
            >
              <Card className="h-full p-5 shadow-lg hover:shadow-2xl transition-all border-0 bg-white/80 backdrop-blur-sm">
                <CardContent className="p-0">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[oklch(0.88_0.08_15)] to-[oklch(0.72_0.20_25)] flex items-center justify-center text-white font-bold text-lg shadow-lg">
                      Е
                    </div>
                    <div>
        ...
        <motion.section
          ...
          className="mb-8"
        >
          <div className="rounded-[2.5rem] p-1.5 bg-gradient-to-br from-peach via-soft-pink to-accent/20">
            <div className="rounded-[2.25rem] p-6 md:p-10 bg-white/95 backdrop-blur-sm">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                <Card className="p-5 shadow-lg border-0 bg-white">
                  <CardContent className="p-0">
                    <div className="flex items-start gap-3.5 mb-2">
                      <div className="w-11 h-11 bg-gradient-to-br from-coral to-[oklch(0.75_0.18_15)] rounded-2xl flex items-center justify-center flex-shrink-0 shadow-md">
                ...
                <Card className="p-5 shadow-lg border-0 bg-white">
                  <CardContent className="p-0">
                    <div className="flex items-start gap-3.5 mb-2">
                      <div className="w-11 h-11 bg-gradient-to-br from-[oklch(0.75_0.18_15)] to-[oklch(0.88_0.08_15)] rounded-2xl flex items-center justify-center flex-shrink-0 shadow-md">
                ...
                <Card className="p-5 shadow-lg border-0 bg-white">
                  <CardContent className="p-0">
                    <div className="flex items-start gap-3.5 mb-2">
                      <div className="w-11 h-11 bg-gradient-to-br from-[oklch(0.88_0.08_15)] to-[oklch(0.72_0.20_25)] rounded-2xl flex items-center justify-center flex-shrink-0 shadow-md">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            <motion.div whileHover={{ scale: 1.02, y: -4 }} transition={{ type: "spring", stiffness: 300 }}>
              <Card className="h-full p-6 shadow-xl border-0 bg-white/90 backdrop-blur-sm hover:shadow-2xl transition-all relative overflow-hidden">
                <div className="absolute top-0 right-0 w-28 h-28 bg-gradient-to-br from-coral to-[oklch(0.75_0.18_15)] opacity-10 rounded-full blur-3xl" />
                <CardContent className="p-0 relative">
                  ...
                  <div className="mb-5">
                    <div className="flex items-baseline gap-2 mb-1">
                      <span className="text-4xl font-bold bg-gradient-to-r from-coral to-accent bg-clip-text text-transparent">1800₽</span>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-2.5">
                      <Sparkle size={22} className="flex-shrink-0 mt-0.5 text-coral" weight="fill" />
                      <span className="font-bold text-sm text-coral">Первое занятие 20-25 минут БЕСПЛАТНО!</span>
                    </li>
                    <li className="flex items-start gap-2.5">
            ...
            <motion.div whileHover={{ scale: 1.02, y: -4 }} transition={{ type: "spring", stiffness: 300 }}>
              <Card className="h-full p-6 shadow-xl border-0 bg-white/90 backdrop-blur-sm hover:shadow-2xl transition-all relative overflow-hidden">
                <div className="absolute top-0 right-0 w-28 h-28 bg-gradient-to-br from-[oklch(0.88_0.08_15)] to-[oklch(0.75_0.18_15)] opacity-10 rounded-full blur-3xl" />
                <CardContent className="p-0 relative">
                  <Badge className="mb-3 bg-soft-pink text-white font-bold text-xs border-0 shadow-md">
                    Выгодное предложение
                  </Badge>
                  <h3 className="text-xl font-bold mb-4">Парные занятия</h3>
                  <div className="mb-5">
                    <div className="flex items-baseline gap-2 mb-1">
                      <span className="text-4xl font-bold bg-gradient-to-r from-[oklch(0.88_0.08_15)] to-accent bg-clip-text text-transparent">1400₽</span>
                      <span className="text-foreground/60 text-base font-semibold">/урок</span>
                    </div>
                  </div>
                  <Separator className="my-4" />
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-2.5">
                      <Chats size={22} className="flex-shrink-0 mt-0.5 text-accent" weight="fill" />
                      <span className="text-sm font-medium">Больше практики общения</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <CheckCircle size={22} className="flex-shrink-0 mt-0.5 text-accent" weight="fill" />
        ...
        <motion.section
          ...
          className="mb-8"
        >
          <div className="rounded-[2.5rem] shadow-2xl p-1.5 bg-gradient-to-br from-coral via-accent to-soft-pink">
            <div className="bg-white rounded-[2.25rem] p-6 md:p-10">
              ...
              <div className="grid md:grid-cols-3 gap-5 max-w-5xl mx-auto mb-6">
                <motion.div whileHover={{ y: -4, scale: 1.03 }} transition={{ type: "spring", stiffness: 300 }}>
                  <Card className="p-5 text-center shadow-lg hover:shadow-xl transition-all border-0 bg-gradient-to-br from-white to-peach/20">
                    <CardContent className="p-0">
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-coral to-[oklch(0.75_0.18_15)] flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <Phone size={26} className="text-white" weight="fill" />
                      </div>
                      <h3 className="font-bold mb-1.5 text-base">Телефон</h3>
                      <a href="tel:+79502274443" className="text-sm font-semibold text-coral hover:opacity-80 transition-colors">
                        +7 (950) 227-44-43
                      </a>
                    </CardContent>
                  </Card>
                ...
                <motion.div whileHover={{ y: -4, scale: 1.03 }} transition={{ type: "spring", stiffness: 300 }}>
                  <Card className="p-5 text-center shadow-lg hover:shadow-xl transition-all border-0 bg-gradient-to-br from-white to-soft-pink/20">
                    <CardContent className="p-0">
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[oklch(0.75_0.18_15)] to-[oklch(0.88_0.08_15)] flex items-center justify-center mx-auto mb-3 shadow-lg">
              ...
              <div className="text-center">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button 
                    size="lg" 
                    className="text-base px-10 py-6 rounded-full shadow-xl hover:shadow-2xl transition-all font-bold bg-coral text-white hover:bg-coral/90 border-0"
                    asChild
                  >
      ...
      <footer className="relative py-8 bg-gradient-to-br from-peach/30 via-soft-pink/30 to-accent/15">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xs text-foreground/60">
            Сделано с <Heart className="inline" weight="fill" size={14} style={{ color: 'oklch(0.70 0.22 20)' }} /> для моих будущих учеников
          </p>
        </div>
      </footer>
    </div>
